 ...
 */
package com.ucmmaster.kafka.data.v3;
...
public class TemperatureTelemetry extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2931091952690233930L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TemperatureTelemetry\",\"namespace\":\"com.ucmmaster.kafka.data.v3\",\"doc\":\"This schema describes a temperature telemetry event produced in a device\",\"fields\":[{\"name\":\"id\",\"type\":\"int\",\"doc\":\"Device id\"},{\"name\":\"temperature\",\"type\":\"int\",\"doc\":\"Temperature Celsius\"},{\"name\":\"humidity\",\"type\":[\"null\",\"int\"],\"doc\":\"Humidity percentage\",\"default\":null},{\"name\":\"read_at\",\"type\":[\"null\",{\"type\":\"long\",\"logicalType\":\"local-timestamp-millis\"}],\"doc\":\"Date and time from the read\",\"default\":null}]}");
  ...
  private java.time.LocalDateTime read_at;
   ...
   */
  public TemperatureTelemetry(java.lang.Integer id, java.lang.Integer temperature, java.lang.Integer humidity, java.time.LocalDateTime read_at) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: read_at = (java.time.LocalDateTime)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder newBuilder() {
    return new com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder();
  }
   ...
   * @return A new TemperatureTelemetry RecordBuilder
   */
  public static com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder newBuilder(com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder other) {
    if (other == null) {
      return new com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder();
    } else {
      return new com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder(other);
    }
  }
   ...
   * @return A new TemperatureTelemetry RecordBuilder
   */
  public static com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder newBuilder(com.ucmmaster.kafka.data.v3.TemperatureTelemetry other) {
    if (other == null) {
      return new com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder();
    } else {
      return new com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TemperatureTelemetry>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ucmmaster.kafka.data.v3.TemperatureTelemetry other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder setTemperature(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder clearTemperature() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder setHumidity(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder clearHumidity() {
      humidity = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder setReadAt(java.time.LocalDateTime value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ucmmaster.kafka.data.v3.TemperatureTelemetry.Builder clearReadAt() {
      read_at = null;
    ...
    public TemperatureTelemetry build() {
      try {
        ...
        record.read_at = fieldSetFlags()[3] ? this.read_at : (java.time.LocalDateTime) defaultValue(fields()[3]);
        return record;
